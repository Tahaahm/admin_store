...
import 'package:admin_store_commerce_shop/pages/upload/category_upload/category_upload_page.dart';
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: ListTile(
                          onTap: () => Get.to(() => CategoryUploadPage(
                                docs: controller.supcategories[index].id,
                              )),
                          leading: Icon(
                            Iconsax.category_25,
