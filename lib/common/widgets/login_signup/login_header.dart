...
import 'package:admin_store_commerce_shop/authentication/pages/signup/signup.dart';
import 'package:admin_store_commerce_shop/pages/login/controllers/login_controller.dart';
import 'package:admin_store_commerce_shop/pages/password_configuration/forget_password.dart';
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Form(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(vertical: Dimentions.height32),
                child: Column(
                  children: [
                    TextFormField(
